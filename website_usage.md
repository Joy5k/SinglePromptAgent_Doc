...
Public keys are created and managed by the **Identity Management** service. Call the Identity Management API from your admin dashboard or backend to create a public key for a tenant. Never expose management APIs to browser code. The generated public key format will be similar to `nxf_pk_6fc2f7ef0bcb03e59307f278f2f51fb57b44fedc4a1b9ed2`. Store it in your website configuration.
